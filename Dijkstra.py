...
class MinHeapArrayBased:
    ...
    def __init__(self, array=list()):
        """
        initializes object of MinHeapArrayBased class
        """
        self.array = array
    ...
    def populate_nodes(self):
        """
        Populate all the nodes of the heap using the given list
        """
        temp = {}
    ...
    def heapify(self, parent):
        """
        Heapify the given node
        parent: Node to heapify
        """
    ...
    def swap(self, a, b):
        """
        Swap the given values in the array and nodes list
        """
    ...
    def dec_node(self, child_index, x):
        """
        Actually a decrease key functions
        :param child_index: child index
        :param x: to update with 
        :return: None
        """
...
class Dijkstra:
    """
    Simulates working of Dijkstra algorithm
    """

    def __init__(self):
        """
        Initializes object of class Dijkstra
        """
    ...
    def read_graph(self):
        """
        Read a graph from given input file
        """
        g = {}
    ...
    def initialize_distances(self, start):
        """
        Initialize all distances from start nose as infinity
        """
